...
const Message: FC<MessageProps> = ({ isSelf = true, data }) => {
  return (
    <div className={`flex items-end${isSelf ? " self-end" : ""}`}>
      <div
        title={data.content}
        className={`max-w-[15rem] break-words rounded-2xl bg-theme px-4 py-2 text-white${
      ...
      <div
        className={`flex h-6 min-w-[1.5rem] translate-y-2 items-center justify-center rounded-full text-xs font-bold uppercase text-white${
